...
#define MSG_TIMER_STOP msg_timer_stop__
#define MSG_TIMER msg_timer__
#define MSG_SAVE_ARRAY msg_save_array__
#define MSG_RESTORE_ARRAY msg_restore_array__
#define MSG_TSETUP msg_tsetup__
